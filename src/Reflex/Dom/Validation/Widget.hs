...
module Reflex.Dom.Validation.Widget where
...
-- we can either have Dynamic t (Validation (NonEmpty ValidityError) Int) / Event t (Validation (NonEmpty ValidityError) Int)
-- or Dynamic t Int / Event t Int / Event t (NonEmpty ValidityError)
